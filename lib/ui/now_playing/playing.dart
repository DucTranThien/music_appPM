...
class _NowPlayingPageState extends State<NowPlayingPage>
        ...
        body: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Colors.black, Colors.purple, Colors.deepPurpleAccent],
    ...
    return StreamBuilder<DurationState>(
      ...
      builder: (context, snapshot) {
        ...
        return ProgressBar(
          ...
          thumbGlowColor: Colors.red.withOpacity(0.5),
          thumbRadius: 10.0,
        );
      },
    );
  ...
  Color? _getShuffleColor() {
    return _isShuffle ? Colors.red : Colors.white30;
  }
  ...
  Color? _getRepeatingIconColor() {
    return _loopMode == LoopMode.off ? Colors.white30 : Colors.red;
  }
  ...
  // Dừng hoàn toàn animation
  void _stopRotationAnim() {
    _imageAnimController.stop();
  }

  // Đặt lại vị trí animation về 0
...
class _MediaButtonControlState extends State<MediaButtonControl> {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      onPressed: widget.function, // Thực thi hàm khi nhấn nút
      icon: Icon(widget.icon), // Biểu tượng nút
      iconSize: widget.size, // Kích thước biểu tượng
      color: widget.color ?? Colors.red, // Màu sắc của nút (đổi sang đỏ)
    );
  }
}
